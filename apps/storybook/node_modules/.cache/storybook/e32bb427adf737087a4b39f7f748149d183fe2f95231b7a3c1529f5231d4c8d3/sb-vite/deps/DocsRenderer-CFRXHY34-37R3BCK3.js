...
import {
  ...
  wt,
  xP
} from "./chunk-CCN7BWBY.js";
import {
  renderElement,
  unmountElement
} from "./chunk-NTQTWZWU.js";
import "./chunk-FHO6LETU.js";
import "./chunk-RV53YYCZ.js";
import "./chunk-FL4VCJUN.js";
import "./chunk-2CGTKWLL.js";
import {
  require_core_events
...
import {
  z
} from "./chunk-OJCH2OH2.js";
import {
  gt,
  yn
} from "./chunk-NJ4DEAQN.js";
import "./chunk-F2TZRQKA.js";
import {
  require_react
} from "./chunk-JZO7B7HW.js";
import {
...
// ../../node_modules/.pnpm/@storybook+addon-docs@8.6.15_@types+react@18.3.0_storybook@8.6.15/node_modules/@storybook/addon-docs/dist/chunk-NUUEMKO5.mjs
var import_react2 = __toESM(require_react(), 1);

// ../../node_modules/.pnpm/@storybook+blocks@8.6.15_react-dom@18.3.1_react@18.3.1__react@18.3.1_storybook@8.6.15/node_modules/@storybook/blocks/dist/index.mjs
...
var Preview = ({ isLoading, isColumn, columns, children, withSource, withToolbar = false, isExpanded = false, additionalActions, className, layout = "padded", ...props }) => {
  let [expanded, setExpanded] = (0, import_react.useState)(isExpanded), { source: source2, actionItem } = getSource(withSource, expanded, setExpanded), [scale, setScale] = (0, import_react.useState)(1), previewClasses = [className].concat(["sbdocs", "sbdocs-preview", "sb-unstyled"]), defaultActionItems = withSource ? [actionItem] : [], [additionalActionItems, setAdditionalActionItems] = (0, import_react.useState)(additionalActions ? [...additionalActions] : []), actionItems = [...defaultActionItems, ...additionalActionItems], { window: globalWindow4 } = globalThis, copyToClipboard = (0, import_react.useCallback)(async (text) => {
    let { createCopyToClipboardFunction } = await import("./components-53VAC3EB.js");
...
var LazyColorControl = (0, import_react.lazy)(() => import("./Color-YHDXOIA2-Z3DNVIIL.js"));
...
var DocsRenderer = class {
  constructor() {
    this.render = async (context, docsParameter, element) => {
      ...
      return new Promise((resolve, reject) => {
        import("./react-YR3PLG4R.js").then(({ MDXProvider }) => renderElement(import_react2.default.createElement(ErrorBoundary, { showException: reject, key: Math.random() }, import_react2.default.createElement(MDXProvider, { components }, import_react2.default.createElement(TDocs, { context, docsParameter }))), element)).then(() => resolve());
      });
...
//# sourceMappingURL=DocsRenderer-CFRXHY34-37R3BCK3.js.map
